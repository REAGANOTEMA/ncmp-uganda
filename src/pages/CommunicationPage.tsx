...
// 2026 Announcements
const ANNOUNCEMENTS = [
  { id: 1, title: "Constituency Day - January 25th", type: "Event", audience: "All Citizens", date: "2026-01-15", status: "Published", views: 1340 },
  { id: 2, title: "Scholarship Applications Open", type: "Program", audience: "Youth", date: "2026-01-12", status: "Published", views: 2950 },
  { id: 3, title: "Road Works Notice - Kireka Road", type: "Notice", audience: "Kireka Residents", date: "2026-01-10", status: "Published", views: 910 },
  { id: 4, title: "Community Health Drive - February", type: "Event", audience: "All Citizens", date: "2026-01-08", status: "Draft", views: 0 },
  { id: 5, title: "Women Empowerment Workshop", type: "Program", audience: "Women", date: "2026-01-05", status: "Published", views: 1600 },
];

// 2026 Events
const EVENTS = [
  { date: "2026-01-25", title: "Constituency Day", location: "Town Hall", time: "9:00 AM" },
  { date: "2026-02-03", title: "Community Health Drive", location: "Health Center", time: "8:00 AM" },
  { date: "2026-02-15", title: "Women's Empowerment Workshop", location: "Community Center", time: "10:00 AM" },
  { date: "2026-03-01", title: "Youth Football Tournament", location: "Nakivubo Stadium", time: "2:00 PM" },
];
...
export default function CommunicationPage() {
  ...
  // Stats
  const stats = [
    { label: "Total Announcements", value: 45, icon: Megaphone, color: "text-primary" },
    { label: "Total Views", value: "19.2K", icon: Eye, color: "text-green-600" },
    { label: "Upcoming Events", value: 5, icon: Calendar, color: "text-amber-600" },
    { label: "Subscribers", value: "3,500", icon: Users, color: "text-purple-600" },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-2xl font-bold text-foreground">Communication & Engagement 2026</h1>
          <p className="text-muted-foreground text-sm mt-1">Publish announcements, manage events and engage citizens</p>
        </div>
        ...
        <div className="gov-card p-6 max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-muted">
              ...
              <p className="text-xs text-muted-foreground">This message will be sent to approximately <strong>13,000 recipients</strong> in your constituency.</p>
            </div>
      ...
      {/* Modal for Announcement/Event */}
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-2xl shadow-gov-lg w-full max-w-lg p-6 animate-slide-up">
            <h3 className="font-display text-xl font-bold text-foreground mb-5">Create Announcement / Event</h3>
            <div className="space-y-4">
              <div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button onClick={() => setShowModal(false)} className="flex-1 h-10 rounded-lg text-sm font-semibold"
                style={{ background: "hsl(var(--primary))", color: "hsl(var(--primary-foreground))" }}>Publish</button>
            </div>
          </div>
        </div>
      )}
